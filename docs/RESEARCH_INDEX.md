...
| `research/beaming_standards.md` | Beaming reference (day 29): grouping, overhangs, beamlets, tuplet-vs-beam — Gould/Read/Ross/Stone, mapped onto this piece's practice; the short-rules card at the end |

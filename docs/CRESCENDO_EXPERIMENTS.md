...
| `r1-onsetmass` | Recipe candidate mined from w5-mass45 keeper passage, longer grains. |
| `r2-sine` / `r2-sine-rex` / `r2-accents` | Shape-lends ladder: what each envelope species provides. |
